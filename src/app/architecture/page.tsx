...
const nodes = [
  ...
  { icon: ServerCog, title: "MCP / query boundary", text: "Live Splunk can replace replay when credentials are configured." },
  ...
  return (
    <main className="architecture-route" data-visual-lane="security-mission-control-cockpit">
      <section className="route-heading">
        ...
        <p>Splunk is the evidence memory, decision context, and verification source. This build uses deterministic replay until live credentials are provided.</p>
        <div className="surface-onboarding inline" aria-label="Architecture first-run examples">
          <span data-placeholder-example>MCP boundary</span>
      ...
      <MissionPanel title="Assumption register">
        <ul className="compact-list">
          ...
          <li>Containment execution is simulated and auditable; no real IAM or firewall changes occur.</li>
          <li>
