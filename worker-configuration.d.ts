/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: e4e0afb9704d9daaafc111e32889c75f)
...
interface __BaseEnv_Env {
	...
	DB: D1Database;
	ASSETS: Fetcher;
	APP_MODE: "seeded-replay";
	HUNTER_DEV_PORT: string;
	DEMO_URL: string;
	TTS_PROVIDER: string;
	TTS_API_KEY: string;
	TTS_BASE_URL: string;
	...
	STEP_MODEL: string;
	STEP_MODEL_DEFAULT: string;
	PRIVATE_KEY: string;
	DEPLOYER_PRIVATE_KEY: string;
	FOUNDRY_PRIVATE_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_MODE" | "HUNTER_DEV_PORT" | "DEMO_URL" | "TTS_PROVIDER" | "TTS_API_KEY" | "TTS_BASE_URL" | "TTS_MODEL" | "TTS_VOICE" | "TTS_FORMAT" | "TTS_SAMPLE_RATE" | "TTS_SPEED" | "TTS_VOLUME" | "TTS_CHUNK_MAX_CHARS" | "TTS_INSTRUCTION" | "MIMO_API_KEY" | "MIMO_BASE_URL" | "MIMO_TTS_MODEL" | "MIMO_TTS_VOICE" | "OPENAI_API_KEY" | "OPENAI_BASE_URL" | "OPENAI_DEFAULT_MODEL" | "OPENAI_MODEL_DEFAULT" | "OPENAI_MODEL_REASONING" | "STEP_API_KEY" | "STEP_BASE_URL" | "STEP_MODEL" | "STEP_MODEL_DEFAULT" | "PRIVATE_KEY" | "DEPLOYER_PRIVATE_KEY" | "FOUNDRY_PRIVATE_KEY" | "EVM_PUBLIC_ADDRESS" | "WALLET_PUBLIC_ADDRESS" | "NEXT_PUBLIC_CHAIN" | "SEPOLIA_RPC_URL" | "BASE_SEPOLIA_RPC_URL">> {}
}
